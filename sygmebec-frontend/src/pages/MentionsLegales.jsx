...
const MentionsLegales = () => {
  return (
    <>
      <SEO title="Mentions légales - GESTMEMBRES" />
      <div className="py-20">
        <div className="container-custom max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            <AnimatedSection delay={0.1}>
              ...
              <p>
                Le site GESTMEMBRES est édité par la société GESTMEMBRES SAS, 
              ...
              <ul>
                ...
                <li><strong>Directeur de la publication :</strong> Marie Dubois</li>
                <li><strong>Hébergeur :</strong> OVH SAS, 2 rue Kellermann, 59100 Roubaix</li>
              </ul>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2}>
              ...
              <p>
                ...
                le droit d'auteur et appartient à GESTMEMBRES SAS. Toute reproduction est interdite 
            ...
            <AnimatedSection delay={0.3}>
              ...
              <p>
                Pour exercer ce droit, contactez-nous à : <strong>contact@gestmembres.com</strong>
              </p>
            </AnimatedSection>
