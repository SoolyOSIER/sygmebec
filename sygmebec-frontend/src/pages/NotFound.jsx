...
const NotFound = () => {
  return (
    <>
      <SEO title="Page non trouvée - GESTMEMBRES" />
          ...
          >
            ...
            <div className="mt-8 p-4 bg-primary-50 rounded-2xl border border-primary-100">
              <p className="text-sm text-gray-600">
                <Search className="w-4 h-4 inline mr-2 text-primary-600" />
                Vous cherchez quelque chose en particulier ? 
                <Link to="/contact" className="text-primary-600 hover:text-primary-700 font-medium ml-1">
                  Contactez-nous
                </Link>
              </p>
            </div>
