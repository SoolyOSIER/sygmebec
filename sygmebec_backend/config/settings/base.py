"""
Django settings for SYGMEBEC project.
...
AUTH_PASSWORD_VALIDATORS = [
    {
        ...
        'OPTIONS': {'user_attributes': ('identifiant',)},
    },
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'SYGMEBEC API',
    'DESCRIPTION': 'API de gestion des membres et événements d\'église',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@sygmebec.org')
